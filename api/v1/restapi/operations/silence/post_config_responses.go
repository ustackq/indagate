...
type PostConfigOK struct {
	...
	/*
	  In: Body
	*/
	Payload *PostConfigOKBody `json:"body,omitempty"`
}
...
// WithPayload adds the payload to the post config o k response
func (o *PostConfigOK) WithPayload(payload *PostConfigOKBody) *PostConfigOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the post config o k response
func (o *PostConfigOK) SetPayload(payload *PostConfigOKBody) {
	o.Payload = payload
}
